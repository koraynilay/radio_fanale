...
<head>
	<meta charset="UTF-8">
	<title>Radio Fanale</title>
	<link rel="stylesheet" href="./assets/css/style.css">
	<!-- Favicon -->
	<link id='favicon' rel="shortcut icon" href="./assets/img/rel_icon/podcast_icon_157488.ico" type="image/x-png">
...
<body>
	<audio id="song" src="http://icecastk:8000/fanale" style="display:none;"></audio>
	<div class="row">
	  <div class="column">
	      <div class="container">
		      <div class="play-btn" id="button">PLAY</div>
	      </div>
	  </div>
	  <div class="column">
	...
	<div id="ciao">
		...
		<form id="input-chat" action="<?= htmlentities($_SERVER['PHP_SELF'], ENT_COMPAT, 'UTF-8'); ?>" method="post">
			<p>
				<input type="text" name="content" id="content" placeholder="Scrivi un messaggio"/>
			</p>
			<p>
				<label id="nome-label">
					Nome:
